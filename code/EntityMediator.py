...
class EntityMediator:
    ...
    #
    # @staticmethod
    # def __verify_collision(entity_list: list[Entity]):
    ...
    # @staticmethod
    # def verify_collision_window(ent: Entity):  # Changed from __verify_collision_window
    #     if isinstance(ent, Enemy):
    #         if ent.rect.right <= 0:
    #             ent.health = 0
    #     if isinstance(ent, PlayerShot):
    ...
    #
    # @staticmethod
    # def verify_collision_entity(ent1, ent2):  # Changed from __verify_collision_entity
    #     valid_interaction = False
    #     if isinstance(ent1, Enemy) and isinstance(ent2, PlayerShot):
    #         valid_interaction = True
    #     elif isinstance(ent1, PlayerShot) and isinstance(ent2, Enemy):
    ...
    #
    # @staticmethod
    # def verify_collision(entity_list: list[Entity]):  # Main public method
    #     for i in range(len(entity_list)):
    #         entity1 = entity_list[i]
    ...
    # @staticmethod
    # def verify_health(entity_list: list[Entity]):
    #    # Safer way to remove dead entities
